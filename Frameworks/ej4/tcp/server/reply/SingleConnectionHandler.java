...
public class SingleConnectionHandler implements IConnectionHandler {
    ...
    protected String endSessionPolicy;
    
    public SingleConnectionHandler(IMessageHandler messageHandler, String endSessionPolicy,
    ...
    public SingleConnectionHandler(String endSessionPolicy) {
    ...
    protected boolean shouldCloseConnection(String message) { return message.equals(this.endSessionPolicy); }
